"""Train v5 with fixed train/validation manifests; held-out test images are never loaded."""
...
EXPECTED_VERSION = "v5"
DEFAULT_CONFIG = "configs/config_v5.yaml"
...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        if config["scheduler"]["name"].lower() != "none":
            raise ValueError("Only scheduler.name=none is implemented for v5")
        scheduler = None
