"""Train v7 with fixed train/validation manifests; held-out test images are never loaded."""
...
EXPECTED_VERSION = "v7"
DEFAULT_CONFIG = "configs/config_v7.yaml"
...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        if config["scheduler"]["name"].lower() != "none":
            raise ValueError("Only scheduler.name=none is implemented for v7")
        scheduler = None
