"""Train v15 with fixed train/validation manifests; held-out test images are never loaded."""
...
DEFAULT_CONFIG = "configs/config_v15.yaml"
...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        if config["scheduler"]["name"].lower() != "none":
            raise ValueError("Only scheduler.name=none is implemented for v15")
        scheduler = None
